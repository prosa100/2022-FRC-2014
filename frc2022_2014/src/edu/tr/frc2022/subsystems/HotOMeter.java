 ...
 * @author prosa
 */
public class HotOMeter extends Subsystem {
    ...
    public double relDistance = 1;
    public final double START_DISTANCE = 100;
        ...
        try {
            ...
            if (filteredImage.getNumberParticles() > 0) {
                ...
                if (verticalTargetCount > 0) {
                    ...
                    relDistance = distance / START_DISTANCE;
