 ...
 * Station, receiving input from the controller, and the Java "MathUtils" class
 * in place of the legacy "CustomMath" library.
 *
 * @param port	The joystick's port
 */
public class Xbawks extends Joystick {
    ...
    public double GetLeftX() {
        return clamp(GetRawAxis(LEFT_XAXIS));
    }
    ...
    public double GetLeftY() {
        return clamp(-1 * GetRawAxis(LEFT_YAXIS));
    ...
    public double GetRightX() {
        return clamp(GetRawAxis(RIGHT_XAXIS));
    }
    ...
    public double GetRightY() {
        return clamp(-1 * GetRawAxis(RIGHT_YAXIS));
    }
    ...
    public double GetTriggers() {
        return clamp(GetRawAxis(TRIGGERS));
    }
    ...
    public double GetLeftAngle(boolean reflectCircle) {
        ...
        if (xAxis == 0 && yAxis == 0) {
            ...
            angle = MathUtils.atan2(yAxis, xAxis);
        }
    ...
    public double GetLeftMagnitude() {
        return clamp(Limit(Math.sqrt(MathUtils.pow(GetLeftX(), (double) (2)) + MathUtils.pow(GetLeftY(), (double) (2)))));
    }
    ...
    public double GetRightMagnitude() {
        return clamp(Limit(Math.sqrt(MathUtils.pow(GetRightX(), (double) (2)) + MathUtils.pow(GetRightY(), (double) (2)))));
    }
    ...
    public float GetRawAxis(int axis) {
        return (float) clamp(super.getRawAxis(axis));
    }
